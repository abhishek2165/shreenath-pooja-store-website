// EXACT SAME CORE CODE + MINIMAL USER-SPECIFIC CART CHANGES
// We'll store cart in localStorage under "cart_<userId>" instead of "cart"

let userId = localStorage.getItem('loggedInUser') || 'guest';

// Load cart & wishlist from localStorage with user-specific keys
...
function removeFromWishlist(index) {
    ...
    // Update user-specific wishlist in localStorage
    localStorage.setItem(`wishlist_${userId}`, JSON.stringify(wishlist));
...
document.addEventListener("DOMContentLoaded", () => {
    // cart & wishlist are already loaded at the top with user-specific keys
